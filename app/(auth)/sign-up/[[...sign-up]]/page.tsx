        ...
        <div className="flex-1 w-full flex flex-col justify-center">
          ...
          <div className="space-y-8">
            <h2 className="text-4xl lg:text-5xl font-bold leading-tight">
              ...
              <span className="text-primary">best content today.</span>
            </h2>
            ...
            <ul className="space-y-6 text-base-content/80 mt-8">
              <li className="flex items-center gap-4 text-lg">
                ...
                <span className="font-medium">Secure, lightning-fast video hosting</span>
              </li>
              <li className="flex items-center gap-4 text-lg">
                <div className="p-3 bg-base-200/50 backdrop-blur-sm rounded-xl border border-base-content/5">
                  <Wand2 className="text-primary" size={24}/>
                </div>
                <span className="font-medium">AI-powered transformations and filters</span>
              </li>
              <li className="flex items-center gap-4 text-lg">
                <div className="p-3 bg-base-200/50 backdrop-blur-sm rounded-xl border border-base-content/5">
                  <Share2 className="text-primary" size={24}/>
                </div>
                <span className="font-medium">Instant optimization for all social formats</span>
              </li>
            </ul>
          </div>
